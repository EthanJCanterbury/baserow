...
BASEROW_SHUTTLEAI_API_KEY = os.getenv("BASEROW_SHUTTLEAI_API_KEY", None)
BASEROW_SHUTTLEAI_MODELS = os.getenv("BASEROW_SHUTTLEAI_MODELS", "")
BASEROW_SHUTTLEAI_MODELS = (
    BASEROW_SHUTTLEAI_MODELS.split(",") if BASEROW_SHUTTLEAI_MODELS else []
)
